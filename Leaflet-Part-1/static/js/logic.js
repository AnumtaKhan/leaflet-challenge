...
function createFeatures(earthquakeData) {
    ...
    // Create popups that provide additional information about the earthquake when its marker is clicked.
   ...
   // Create a variable for earthquakes to have the latlong, popup feature, and the radious, colour, weight, and opacity of each circle
  ...
  // Create Data markers that reflect the magnitude of the earthquake by their size and the depth of the earthquake by color.
